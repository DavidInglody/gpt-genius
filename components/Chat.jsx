  ...
  const {userId}= useAuth()
    ...
    const {mutate, isPending} =useMutation({
      ...
      if(!response){
        ...
        toast.success(`${newTokens} remaining`)
      }
    })
    ...
    <div className="min-h-[calc(100vh-6rem)] grid grid-rows-[1fr,auto]">
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl pt-12">
        <div className="join w-full">
          <input type="text" placeholder="Message Genius GPT" className="input input-bordered join-item w-full" value={text} required onChange={(e)=> setText(e.target.value)}/>
